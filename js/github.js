...
// Request raw media from GitHub API (avoids raw.githubusercontent.com CORS)
const mediaRes = await fetch(url, {
  headers: Object.assign({}, headers(cfg), {
    "Accept": "application/vnd.github.raw"
  })
});
if (!mediaRes.ok) {
  throw new Error(`GitHub media download failed for ${path} (HTTP ${mediaRes.status})`);
}
