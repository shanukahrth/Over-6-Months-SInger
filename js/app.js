...
window.Shared = (function () {
  ...
  function initAuthGate() {
    ...
    // ALWAYS prefer the deployment's shared config when present.
    // This deliberately runs before the localStorage/configured check so an
    // old browser credential can never force the GitHub setup screen.
